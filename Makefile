...
help: ## Список команд
	@echo "$(C_YELLOW)  _       _     __    ____  $(CE)"
	@echo "$(C_YELLOW) | |     | |   /  |  / ___| $(CE)"
	@echo "$(C_YELLOW) | | __ _| |__ '| | / /___  $(CE)"
	@echo "$(C_YELLOW) | |/ _' | '_ \ | | | ___ \ $(CE)"
	@echo "$(C_YELLOW) | | (_| | |_) || |_| \_/ | $(CE)"
	@echo "$(C_YELLOW) |_|\__,_|_.__/\___/\_____/ $(CE)"
	@echo "$(C_GREEN)                     lab16  $(CE)"
	@echo ""
...
stop: ##@Projects Останавливает проект
	...
	sudo docker stop lab16_backend_1
	@echo ""

	@echo "$(C_GREEN)Stop ngnix proxy$(CE)"
	sudo docker stop lab16_proxy_1
	@echo ""
...
del: ##@Projects Удаляет контейнеры
	...
	sudo docker rm lab16_backend_1
	@echo ""

	@echo "$(C_GREEN)Stop ngnix proxy$(CE)"
	sudo docker stop lab16_proxy_1
	@echo "$(C_RED)Delete ngnix proxy $(CE)"
	sudo docker rm lab16_proxy_1
	@echo ""
